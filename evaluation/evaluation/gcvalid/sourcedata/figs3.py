...
from gcvalid.sourcedata import HWMS_FILTERED_PANEL_CONFIGS, stats_hwms_filtered
...
def main():
    ...
    for panel, panel_config in zip("abcd", HWMS_FILTERED_PANEL_CONFIGS):
        df = stats_hwms_filtered(args.source, args.fes, args.prot, models, panel_config)
